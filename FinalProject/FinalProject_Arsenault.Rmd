...
Note: I took your advice and simplified my project a bit to make it more feasible for the timeframe. While the original sampling design included sampling sub-habitats within each of 4 major sites (MMR, SCR, PEP, and WIN), I am ignoring those and just focusing on differences among the 4 sites themselves.
...
projpacks <-  c("checkpoint", "plyr", "mapdata", "RColorBrewer", "maps", "maptools", "ggplot2", "SIBER") #packages used in this project
