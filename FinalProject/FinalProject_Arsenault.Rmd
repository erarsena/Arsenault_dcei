...
Here, we conduct a large-scale study of food web dynamics to investigate the effects of hydrogeomorphology on ecosystem function within a macrosystem framework. In particular, we investigated the effect of river hydrogeomorphology on fish food web complexity in four unique FPZs of the Upper Mississippi River to answer the primary research question, What is the effect of FPZ on fish food web complexity in the Upper Mississippi River, with the prediction that fish food web complexity would increase with FPZ and habitat complexity. RANGE OF N AND RANGE OF C SHOULD INCREASE WITH INCREASING COMPLEXITY.
...
At each river site sampled, hydrogeomorphic measurements were taken at transects placed at 500-m intervals along a 10-km reach. The wetted width, or the linear distance between banks at water level, was measured at each transect. We also determined the number of channels intersected by the transect and the number of islands between transects and then used these measurements to quantify channel complexity. Sinuosity of the 10-km sections of a given site and the area of the drainage basin above the site were also determined. A cumulative measure of geomorphic complexity was then produced with each of these __ variables, ranked by increasing complexity. Ranks for all variables were summed to provide a single measure of hydrogeomorphic complexity for each site.
