...
```{r feedingplot, echo=F, results="hide", fig.cap="Biplot of $\delta^{13}C$ and d15N$\delta^{15}N$ bulk tissue isotope signatures for fish collected in four FPZs of the Mississippi River (n=514). Points are colored according to site FPZ, with MMR in red, PEP in blue, SCR in green, and WIN in black."}
