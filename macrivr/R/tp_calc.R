...
#
#Args
#' @param fish      A dataframe with d15N data for fish at different sites along a river
#' @param frac      Trophic discrimination factor used to calculate trophic position (default = 3.4)
#
